...
var KafkaTopicConversion = "conversion"
...
func conversion(c *gin.Context) {
	...
	if requestBody.AdsSeqNum == "" || requestBody.AdsClickUrl == "" {
	...
	kafka.SendMessage(producer, KafkaTopicConversion, message, requestBody.HbaseRowKey)
