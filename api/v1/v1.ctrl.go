...
var KafkaTopicWifi = "wifi"
var KafkaTopicOpenId = "open_id"
...
func wifi(c *gin.Context) {
	...
	requestBody = Tasks.UrlAppendDatetime(requestBody)
	requestBody = Tasks.GetRowKey(requestBody)
	requestBody = Tasks.UrlAppendWifiInfo(requestBody)
	...
	kafka.SendMessage(producer, KafkaTopicWifi, message, requestBody.HbaseRowKey)
	c.AbortWithStatus(200)
}
...
func openId(c *gin.Context) {
	...
	kafka.SendMessage(producer, KafkaTopicOpenId, message, requestBody.HbaseRowKey)
	c.AbortWithStatus(200)
}
